    ...
    <div class="screen">
        <div class='single_person'>
            ...
            <Modal  :show="if_show_mask" :title="modal_title" @hideModal="hideModal">
                <div class="modal_main_leave_home" v-if="modal_title=='离家模式'">
                    <ProductCard v-for="(item,index) in modal_product_list_leaveHome" :name="item.name" :img_url="item.img_url" :product_img="item.product_img" :key="index"></ProductCard>
                </div>
           </Modal>
        </div>
    </div>
...
export default {
  ...
  data() {
    return {
        output_text: "单身人士：xxxxxxxxxxxxxxx是xxxxxxxxxxxxxxxx",
        if_show_mask:false,
        modal_title:'防盗警报',
        ...
        service_list:[
            {
                title:'机器清洁服务',
                img_url:require('./assets/imges/single_person/机器清洁服务.png')
            },
            {
                title:'生活缴费服务',
                img_url:require('./assets/imges/single_person/生活缴费服务.png')
            },
            {
                title:'健康饮水指导',
                img_url:require('./assets/imges/single_person/健康饮水.png')
            },
            {
                title:'空气质量查询',
                img_url:require('./assets/imges/single_person/空气.png')
            },
            {
                title:'美妆建议',
                img_url:require('./assets/imges/single_person/美妆建议.png')
            },
            {
                title:'睡眠音乐内容',
                img_url:require('./assets/imges/single_person/睡眠音乐内容.png')
            },
            {
                title:'家政清洁服务',
                img_url:require('./assets/imges/single_person/家政清洁服务.png')
            },
            {
                title:'穿搭推荐',
                img_url:require('./assets/imges/single_person/穿搭.png')
            },{
                title:'食材送货服务',
                img_url:require('./assets/imges/single_person/食材送货服务.png')
            },
            {
                title:'圈子社区',
                img_url:require('./assets/imges/single_person/圈子.png')
            },
            {
                title:'外卖服务',
                img_url:require('./assets/imges/single_person/外卖.png')
            },
            {
                title:'健康饮食建议',
                img_url:require('./assets/imges/single_person/健康饮食.png')
            }
        ],
        AI_list:[
            {
        ...
        modal_product_list_leaveHome:[
            {
                name:'全屋家电关闭',
                img_url:require('./assets/imges/single_person/边框.png'),
                product_img:require('./assets/imges/single_person/离家模式.png')
            }
        ]  
    };
  },
  ...
  methods: {
      ...
      showModal(text){
          if(text=='防盗警报'){
            this.modal_title='防盗警报'
            this.output_text='已为您启动防盗警报，在该模式下，将联动xxxxxx'
            this.if_show_mask=true 
            this.modal_languageOutput_class=true
          }
          if(text=="离家模式"){
            this.modal_title='离家模式'
            this.output_text='已为您启动防盗警报，在该模式下，将联动xxxxxx'
            this.if_show_mask=true 
            this.modal_languageOutput_class=true
          }
    ...
    .single_person{
        ...
        .body{
            ...
            .big_img{
                ...
                width: 880px;
                height: 725px;
                background-image: url(./assets/imges/single_person/单身人士.png);
                background-repeat: no-repeat;
                background-position:center center;
